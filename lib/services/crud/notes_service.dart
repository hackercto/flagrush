...
import 'package:flagrush/extensions/list/filter.dart';
import 'package:flagrush/services/crud/crud_exceptions.dart';
...
class DatabaseNote {
  ...
  @override
  String toString() =>
      'Note (id: $id, userId: $userId, text: $text, isSyncedWithCloud: $isSyncedWithCloud, text: $text)';
...
const createNoteTable = '''CREATE TABLE IF NOT EXISTS "note" (
  ...
  $textColumn TEXT,
  $isSyncedWithCloudColumn INTERGER NOT NULL DEFAULT 0,
